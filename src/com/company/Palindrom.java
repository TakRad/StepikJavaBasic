...
public class Palindrom {
    ...
    public static void main(String[] args) {
        System.out.println(isPalindrome("Madam, I'm not Adam!"));
    }
    ...
    public static boolean isPalindrome(String text) {
        String textUpCase = text.replaceAll("[^a-zA-Z0-9]","").toUpperCase();
        String reverse = new StringBuilder(textUpCase).reverse().toString();
        return textUpCase.equals(reverse);
    }
}
